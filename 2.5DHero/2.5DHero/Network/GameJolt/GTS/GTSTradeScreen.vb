    ...
    Public Class GTSTradeScreen
        ...
        Public Overrides Sub Update()
            ...
            If Controls.Accept(True, False) = True Then
                If New Microsoft.Xna.Framework.Rectangle(180, 560, 32 * 5 + 64, 32).Contains(MouseHandler.MousePosition) = True Then
                    Core.SetScreen(New ChoosePokemonScreen(Me, Item.GetItemByID(5), AddressOf ChosePokemon, "Chose Pokémon to trade!", True))
                End If
                If New Microsoft.Xna.Framework.Rectangle(180, 510, 32 * 5 + 64, 32).Contains(MouseHandler.MousePosition) = True Then
                    PokeIndex = -1
                End If
                If New Microsoft.Xna.Framework.Rectangle(780, 560, 32 * 5 + 64, 32).Contains(MouseHandler.MousePosition) = True Then
                    Core.SetScreen(New PokemonStatusScreen(Me, 0, {D.Pokemon}, D.Pokemon, False))
                End If
                If New Microsoft.Xna.Framework.Rectangle(520, 560, 32 * 3 + 64, 32).Contains(MouseHandler.MousePosition) = True Then
        ...
        Public Overrides Sub Draw()
            ...
            Core.SpriteBatch.DrawString(FontManager.InGameFont, "Trade", New Vector2(560, 160), Microsoft.Xna.Framework.Color.White)
            ...
            'Own:
            Canvas.DrawRectangle(New Microsoft.Xna.Framework.Rectangle(100 + OwnX, 160, 400, 450), New Microsoft.Xna.Framework.Color(255, 255, 255, 150))
            ...
            If Core.Player.IsGamejoltSave = True Then
                ...
                Core.SpriteBatch.Draw(ownEmblem.SpriteTexture, New Microsoft.Xna.Framework.Rectangle(110, 90, 64, 64), New Microsoft.Xna.Framework.Rectangle(0, SpriteSize.Height * 2, SpriteSize.Width, SpriteSize.Height), Microsoft.Xna.Framework.Color.White)
                Core.SpriteBatch.DrawString(FontManager.InGameFont, ownEmblem.Username, New Vector2(183, 115), Microsoft.Xna.Framework.Color.Black)
                Core.SpriteBatch.DrawString(FontManager.InGameFont, ownEmblem.Username, New Vector2(180, 112), Microsoft.Xna.Framework.Color.White)
            End If
            ...
            If Not P Is Nothing Then
                'Pokemon image/data:
                Core.SpriteBatch.Draw(P.GetTexture(True), New Microsoft.Xna.Framework.Rectangle(100 + OwnX, 164, 128, 128), Microsoft.Xna.Framework.Color.White)

                If P.GetDisplayName() <> P.OriginalName Then
                    Core.SpriteBatch.DrawString(FontManager.MainFont, P.GetDisplayName(), New Vector2(230 + OwnX, 190), Microsoft.Xna.Framework.Color.Black)
                    Core.SpriteBatch.DrawString(FontManager.MainFont, "/" & P.OriginalName, New Vector2(240 + OwnX, 220), Microsoft.Xna.Framework.Color.Black)
                Else
                    Core.SpriteBatch.DrawString(FontManager.MainFont, P.GetDisplayName(), New Vector2(230 + OwnX, 205), Microsoft.Xna.Framework.Color.Black)
                End If
                ...
                If PokeIndex > -1 Then
                    ...
                    If Not P.Item Is Nothing Then
                        ...
                        Core.SpriteBatch.Draw(P.Item.Texture, New Microsoft.Xna.Framework.Rectangle(202 + OwnX, 474, 24, 24), Microsoft.Xna.Framework.Color.White)
                    End If
                ...
                Else
                    ...
                    Core.SpriteBatch.DrawString(FontManager.MiniFont, "Request Level: " & D.RequestLevel & vbNewLine & vbNewLine &
                                                 "Request Gender: " & GenderString, New Vector2(150 + OwnX, 360), Microsoft.Xna.Framework.Color.Black)
                End If
            ...
            'Other:
            Canvas.DrawRectangle(New Microsoft.Xna.Framework.Rectangle(100 + OppX, 160, 400, 450), New Microsoft.Xna.Framework.Color(255, 255, 255, 150))

            Core.SpriteBatch.DrawString(FontManager.MiniFont, "Transaction ID: " & D.TradeID, New Vector2(706, 160), Microsoft.Xna.Framework.Color.Black)

            'User:
            If E.DoneLoading = True Then
                Dim spriteSize As New Size(CInt(E.SpriteTexture.Width / 3), CInt(E.SpriteTexture.Height / 4))
                Core.SpriteBatch.Draw(E.SpriteTexture, New Microsoft.Xna.Framework.Rectangle(710, 90, 64, 64), New Microsoft.Xna.Framework.Rectangle(0, spriteSize.Height * 2, spriteSize.Width, spriteSize.Height), Microsoft.Xna.Framework.Color.White)
                Core.SpriteBatch.DrawString(FontManager.InGameFont, E.Username, New Vector2(783, 115), Microsoft.Xna.Framework.Color.Black)
                Core.SpriteBatch.DrawString(FontManager.InGameFont, E.Username, New Vector2(780, 112), Microsoft.Xna.Framework.Color.White)
            Else
                Core.SpriteBatch.DrawString(FontManager.InGameFont, "Loading" & LoadingDots.Dots, New Vector2(783, 115), Microsoft.Xna.Framework.Color.Black)
                Core.SpriteBatch.DrawString(FontManager.InGameFont, "Loading" & LoadingDots.Dots, New Vector2(780, 112), Microsoft.Xna.Framework.Color.White)
            End If

            If Not D.Pokemon Is Nothing Then
                'Pokemon image/data:
                Core.SpriteBatch.Draw(D.Pokemon.GetTexture(True), New Microsoft.Xna.Framework.Rectangle(100 + OppX, 164, 128, 128), Microsoft.Xna.Framework.Color.White)

                If D.Pokemon.GetDisplayName() <> D.Pokemon.OriginalName Then
                    Core.SpriteBatch.DrawString(FontManager.MainFont, D.Pokemon.GetDisplayName(), New Vector2(230 + OppX, 190), Microsoft.Xna.Framework.Color.Black)
                    Core.SpriteBatch.DrawString(FontManager.MainFont, "/" & D.Pokemon.OriginalName, New Vector2(240 + OppX, 220), Microsoft.Xna.Framework.Color.Black)
                Else
                    Core.SpriteBatch.DrawString(FontManager.MainFont, D.Pokemon.GetDisplayName(), New Vector2(230 + OppX, 205), Microsoft.Xna.Framework.Color.Black)
                End If

                Dim ItemString As String = "None"
                If Not D.Pokemon.Item Is Nothing Then
                    ItemString = "   " & D.Pokemon.Item.Name
                    Core.SpriteBatch.Draw(D.Pokemon.Item.Texture, New Microsoft.Xna.Framework.Rectangle(202 + OppX, 474, 24, 24), Microsoft.Xna.Framework.Color.White)
                End If
            ...
            If MeetsCondition() = True Then
                ...
                If v > 0 Then
                    Canvas.DrawRectangle(New Microsoft.Xna.Framework.Rectangle(540, 430, 120, 120), New Microsoft.Xna.Framework.Color(255, 255, 255, 150))

                    Core.SpriteBatch.DrawString(FontManager.MiniFont, "You get" & vbNewLine & "stars:", New Vector2(560, 435), Microsoft.Xna.Framework.Color.Black)
            ...
            Else
                If PokeIndex > -1 Then
                    ...
                    End If
                    Core.SpriteBatch.DrawString(FontManager.MiniFont, t, New Vector2(120, 300), Microsoft.Xna.Framework.Color.Black)
                End If
            End If
                    ...
                    If D.RequestGender <> "" Then
                        Select Case D.RequestGender
                            ...
                            Case "Female"
                                ...
                                End If
                            Case "Genderless"
                                If P.Gender <> BasePokemon.Genders.Genderless Then
                                    Return False
                                End If
                        End Select
                    End If
        ...
        Class TradingScreen
            ...
            Public Overrides Sub Draw()
                ...
                If UploadDone = False Then
                    ...
                    Core.SpriteBatch.DrawString(FontManager.MainFont, "Trading" & LoadingDots.Dots, New Vector2(CSng(Core.windowSize.Width / 2 - FontManager.MainFont.MeasureString("Uploading").X / 2), 300), Microsoft.Xna.Framework.Color.Black)
                    Core.SpriteBatch.DrawString(FontManager.MainFont, "Transaction ID: " & D.TradeID, New Vector2(CSng(Core.windowSize.Width / 2 - FontManager.MainFont.MeasureString("Transaction ID: " & D.TradeID).X / 2), 370), Microsoft.Xna.Framework.Color.Black)

                    Core.SpriteBatch.DrawString(FontManager.MiniFont, "Version " & GTSMainScreen.GTSVersion, New Vector2(4, Core.windowSize.Height - 1 - FontManager.MiniFont.MeasureString("Version " & GTSMainScreen.GTSVersion).Y), Microsoft.Xna.Framework.Color.DarkGray)
                Else
                    Fur.Draw()
                    Core.SpriteBatch.Draw(D.Pokemon.GetTexture(True), New Microsoft.Xna.Framework.Rectangle(CInt(P1Pos.X), CInt(P1Pos.Y), 128, 128), Microsoft.Xna.Framework.Color.White)
                    Core.SpriteBatch.Draw(P.GetTexture(True), New Microsoft.Xna.Framework.Rectangle(CInt(P2Pos.X), CInt(P2Pos.Y), 128, 128), Microsoft.Xna.Framework.Color.White)
