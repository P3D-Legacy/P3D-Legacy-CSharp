...
Public Class Ability
    Inherits BaseAbility

    Private Class AbilityManagerImplementation
        Inherits AbilityManager

        Public Overrides Function GetAbilityByID(ByVal ID As Integer) As BaseAbility
            Select Case ID
                Case 1
    ...
    Public Sub New(ByVal ID As Integer, ByVal Name As String, ByVal Description As String)
        MyBase.New(ID, Name, Description)
    End Sub
End Class