...
Namespace Items.KeyItems
    ...
    Public Class SuperRod
        ...
        Public Sub New()
            TextureRectangle = New Rectangle(312, 48, 24, 24)
        End Sub

        Public Overrides Sub Use()
            If OldRod.IsInfrontOfWater() = True And Screen.Level.IsSurfing = False And Screen.Level.IsRiding = False Then
                ...
                If GameModeManager.MapFileExistsAsync(pokeFile).Result = True Then
                    p = Spawner.GetPokemon(Screen.Level.LevelFile, EncounterMethods.SuperRod, False)
                End If
