...
Namespace BattleSystem.Moves.Flying
    ...
    Public Class OblivionWing
        ...
        Public Overloads Sub MoveHits(own As Boolean, BattleScreen As BattleScreen)
            ...
            End If
            Dim heal As Integer = CInt(Math.Ceiling(damage * (3 / 4)))
            ...
            Else
                ...
                End If
                If healBlock = 0 Then
                    BattleScreen.Battle.GainHP(heal, own, own, BattleScreen, op.GetDisplayName() & " had its energy drained!", "move:oblivionwing")
                End If
            End If
        End Sub
