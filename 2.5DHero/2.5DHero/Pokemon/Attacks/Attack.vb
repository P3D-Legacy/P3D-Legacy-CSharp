...
Namespace BattleSystem
    ...
    Public Class Attack
        ...
        Private Class AttackManagerImplementation
            Inherits AttackManager

            ''' <summary>
            ''' Returns a new instance of AttackV2 based on the input ID.
            ''' </summary>
            ''' <param name="ID">The ID of the Move to return.</param>
            Public Overrides Function GetAttackByID(ByVal ID As Integer) As BaseAttack
        ...
        Shared Sub New()
            AM = New AttackManagerImplementation()
        End Sub
