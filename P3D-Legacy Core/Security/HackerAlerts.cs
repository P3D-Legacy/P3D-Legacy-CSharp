...
namespace P3D.Legacy.Core.Security
{
    public class HackerAlerts
    {
        ...
        private static void TimerTick(object sender, ElapsedEventArgs elapsedEventArgs)
        {
            ...
            string text = @"Hey, we have detected that you attempted to hack the game. Please don't do that. We are trying to create an online experience where everyone is set equal, where everyone can play the game and achieve about the same things by playing the same amount of time.
