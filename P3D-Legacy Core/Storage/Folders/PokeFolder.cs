...
{
    public class PokeFolder : IFolder
    {
        ...
        public PokeFolder(IFolder folder) { _folder = folder; }
        public PokeFolder(string path) { _folder = FileSystem.Current.GetFolderFromPathAsync(path).Result; }
