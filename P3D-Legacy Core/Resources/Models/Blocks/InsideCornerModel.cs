...
public class InsideCornerModel : BaseModel<InsideCornerModel>
{
    ...
    static InsideCornerModel()
    {
        ...
        VertexData.Add(new VertexPositionNormalTexture(new Vector3(-0.5f, 0.5f, -0.5f), new Vector3(0, 0, -1), new Vector2(0.0f, 0.0f))); //f
        ...
        VertexData.Add(new VertexPositionNormalTexture(new Vector3(-0.5f, 0.5f, -0.5f), new Vector3(1, 0, 0), new Vector2(1.0f, 0.0f))); //f
