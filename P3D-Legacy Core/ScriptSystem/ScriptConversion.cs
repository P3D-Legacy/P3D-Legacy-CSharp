...
{
    /// <summary>
    /// Used to convert strings into various Element.Types.
    /// </summary>
    public class ScriptConversion
    {
        ...
        public static double ToDouble(object expression)
        {
            ...
            else
            {
                ...
                {
                    bool b = false;
                    string postFix = ToPostfix(expression.ToString(), ref b);

                    return EvaluatePostfix(postFix, ref b);
                }
                else
                {
                    return 0d;
        ...
        {
            expression = expression.Replace(".", new NumberFormatInfo().NumberDecimalSeparator);
        ...
        {
            return Convert.ToInt32(Math.Round(ToDouble(expression)));
        }
        ...
        {
            return Convert.ToSingle(ToDouble(expression));
        }
