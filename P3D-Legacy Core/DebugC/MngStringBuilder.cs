...
namespace P3D.Legacy.Core.DebugC
{
    ...
    public sealed class MngStringBuilder
    {
        ...
        public MngStringBuilder AppendAt(int index, StringBuilder s)
        {
        ...
        public MngStringBuilder Append(string s)
        {
            this.StringBuilder.Append(s);

            return this;
        }
        public MngStringBuilder Append(byte value)
        {
            // basics
            int num = value;
            if (num == 0)
        ...
        public MngStringBuilder Append(short value)
        {
            int num = value;
            // basics
            if (num < 0)
        ...
        public MngStringBuilder Append(int value)
        {
            // basics
            if (value < 0)
            {
        ...
        public MngStringBuilder Append(long value)
        {
            // basics
            if (value < 0)
            {
        ...
        public MngStringBuilder Append(float value)
        {
            // basics
            if (value < 0)
            {
        ...
        public MngStringBuilder Append(double number)
        {
        ...
        public MngStringBuilder AppendTrim(float value)
        {
            // basics
            if (value < 0)
            {
        ...
        public MngStringBuilder AppendTrim(double number)
        {
            // basics
            if (number < 0)
            {
        ...
        public MngStringBuilder AppendLine(StringBuilder s)
        {
            Append(s);
            sb.AppendLine();
        ...
        public MngStringBuilder AppendLine(string s)
        {
            sb.AppendLine(s);

            return this;
        }
        public MngStringBuilder AppendLine()
        {
            sb.AppendLine();
        ...
        public MngStringBuilder Insert(int index, StringBuilder s)
        {
            this.StringBuilder.Insert(index, s);

            return this;
        }
        public MngStringBuilder Remove(int index, int length)
        {
